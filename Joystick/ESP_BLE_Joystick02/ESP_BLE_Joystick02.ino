...
//  }
  ...
  if (btConnected && btReceiveDone && btRxLoad.length()>0){
    ...
    if (btRxLoad == RIGHT) {
      PTLF("right");
    } else if (btRxLoad == LEFT) {
      PTLF("left");
    } else if (btRxLoad == FORWARD) {
      PTLF("forward");
    } else if (btRxLoad == BACK) {
      PTLF("back");
    } else if (btRxLoad == CRAWL) {
      PTLF("crawl");
    } else if (btRxLoad == WALK) {
      PTLF("walk");
    } else if (btRxLoad == TROT) {
      PTLF("trot");
    } else if (btRxLoad == REST) {
      PTLF("rest");
    } else if (btRxLoad == BALANCE) {
      PTLF("balance");
    } else if (btRxLoad == HELLO) {
      PTLF("hello");
    } else if (btRxLoad == SIT) {
      PTLF("sit");
    }
    btRxLoad="";
  }
